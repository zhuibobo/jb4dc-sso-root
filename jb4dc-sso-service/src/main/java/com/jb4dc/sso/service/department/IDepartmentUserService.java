...
public interface IDepartmentUserService {
    int save(JB4DCSession jb4DSession, String id, DepartmentUserBO record, String accountPassword) throws JBuild4DCGenerallyException;

    DepartmentUserBO getEmptyNewVo(JB4DCSession jb4DSession, String departmentId) throws JBuild4DCGenerallyException;
    ...
    DepartmentUserBO getVo(JB4DCSession jb4DSession, String departmentUserId) throws JBuild4DCGenerallyException;
